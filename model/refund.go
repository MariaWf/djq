...
func (obj *Refund) GetValue4Map(name string) interface{} {
	...
	case "id":
		return obj.Id
	case "cashCouponOrderId":
		return obj.CashCouponOrderId
	case "evidence":
		return obj.Evidence
	case "reason":
		return obj.Reason
	case "comment":
		return obj.Comment
	case "refundAmount":
		return obj.RefundAmount
	case "status":
		return obj.Status
	case "refundOrderNumber":
		return obj.RefundOrderNumber
	case "refundBegin":
		return obj.RefundBegin
	case "refundEnd":
		return obj.RefundEnd
	}
